...
const channel = '#schusteruk';  // Replace with your channel.
const account = 'schusteruk';   // Replace with the account the bot runs as
const password = 'oauth:d49pevfzrmpi3unwq5ce58wz5ny1wt';
